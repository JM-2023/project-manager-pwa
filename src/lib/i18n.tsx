...
const en = {
  ...
  settings: {
    ...
    groupDiagnostics: "Sync diagnostics",
    diagnosticsHint: "A live log of every sync step on this device. If changes stop syncing, copy it or take a screenshot.",
    diagnosticsEmpty: "Nothing recorded yet.",
...
const zh: Messages = {
  ...
  settings: {
    ...
    groupPreferences: "外观",
    groupAccount: "账户",
    groupDiagnostics: "同步诊断",
    diagnosticsHint: "本设备上每一步同步的实时记录。如果修改不再同步，请复制或截图这里。",
    diagnosticsEmpty: "暂无记录。",
    copyDiagnostics: "复制记录",
